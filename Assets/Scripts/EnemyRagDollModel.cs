...
public class EnemyRagDollModel : MonoBehaviour
{
    ...
    private IEnumerator SimulateGravity()
    {
        ...
        {
            bone.AddExplosionForce(Random.Range(200, 250), new Vector3(_body.transform.position.x - Random.Range(1,3), _body.transform.position.y + Random.Range(1,3), _body.transform.position.z), 12);
        }
